# -*- coding: utf-8 -*-
"""
Created on Sun Jul 14 14:54:22 2024
...
for i in range(forecast_horizon):
    ...
    next_close_price = model.predict(X_forecast)[0]
...
plt.title('Bitcoin Price Prediction and Forecast using K-Nearest Neighbors Regression')
plt.xlabel('Time')
plt.ylabel('Price')
plt.legend()
plt.grid(True)
