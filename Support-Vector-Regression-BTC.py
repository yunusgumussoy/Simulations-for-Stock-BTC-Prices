# -*- coding: utf-8 -*-
"""
Created on Sun Jul 14 14:47:43 2024

@author: Yunus
"""

# Support Vector Regression (SVR) for predicting and forecasting Bitcoin prices
...
model = SVR(kernel='rbf', C=100, gamma='auto')  # You can adjust C and gamma as needed
...
for i in range(forecast_horizon):
    ...
    next_close_price = model.predict(X_forecast_scaled)[0]
...
plt.title('Bitcoin Price Prediction and Forecast using SVR')
plt.xlabel('Time')
plt.ylabel('Price')
plt.legend()
plt.grid(True)
